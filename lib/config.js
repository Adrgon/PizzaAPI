...
environments.staging = {
	...
	'envName': 'staging',
	'isTesting': true,
	'testEmail': 'tumail@gmail.com',
	'hashingSecret': 'pizzaIsDelicious',
	'stripe': {
		'publicKey': 'TuPublicKey',
		'secretKey': 'TuSecretKey',
		'currency': 'Pesos',
		'currencySign': '$',
		'source': 'tok_visa'
	},
	'mailGun': {
		...
		'apiKey': 'TuApikey',
		'senderMail': "Pizza <postmaster@sandboxXXX.mailgun.org>"
	}
};
...
environments.production = {
	...
	'mailGun': {
		...
		'domain': 'sandboxXXX.mailgun.org',
		'apiKey': 'TuApikey', //unescape the chars?
		'senderMail': 'Pizza <postmaster@sandboxXXX.mailgun.org>'
	}
};

//Determine which environment was passed as a command line arg
let currentEnvironment = typeof (process.argv[2]) == 'string' ? process.argv[2].toLowerCase() : '';
